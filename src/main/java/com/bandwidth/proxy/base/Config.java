...
public class Config {
    ...
    public Config(int localSocksPort, int localHttpPort, String serverHost, int serverPort, String secretKey, String serverBindIp, int serverBindPort, String dnsList) {
